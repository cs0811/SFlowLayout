...
+ (UICollectionViewLayoutAttributes *)layoutAttributesForDecorationViewOfKind:(NSString *)decorationViewKind
    ...
    CHTCollectionViewLayoutAttributes *layoutAttributes = [super layoutAttributesForDecorationViewOfKind:decorationViewKind
  ...
  for (NSInteger section = 0; section < numberOfSections; ++section) {
    ...
    for (idx = 0; idx < itemCount; idx++) {
      ...
      self.columnHeights[section][columnIndex] = @(CGRectGetMaxY(attributes.frame) + minimumInteritemSpacing);
        ...
        decorationAttributes.frame = CGRectMake(xOffset-sectionInset.left, yOffset-sectionInset.top, self.collectionViewContentSize.width, itemHeight+sectionInset.top+sectionInset.bottom);
